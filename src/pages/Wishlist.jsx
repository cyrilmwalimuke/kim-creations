...
export default function Wishlist() {
    ...
    useEffect(() => {
      const fetchWishes = async () => {
          try {
              const response = await fetch('https://brasscraftstudio.com//wishes/67cc5b5164b738dcaa6b7f50'); // Your API endpoint
    ...
    <div>
      ...
      <section className="relative h-300px sm:h-[400px] w-full overflow-hidden bg-[url('/placeholder.svg?height=800&width=1600')] bg-cover bg-center">
          ...
          <div className="container relative z-10 flex h-full flex-col items-center justify-center text-center">
            ...
            Save exquisite designs that blend elegance with contemporary charm.
            </p>
            <button onClick={()=>scrollToSection()} to='/shop' className="mt-8 bg-white p-1 " size="lg">
              Explore Collection
            </button>
          </div>
        </section>
        ...
        <section className="container py-12 md:py-16 px-8">
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <h2 className="font-serif text-3xl font-medium">❤️A collection just for you</h2>
                <p className="text-muted-foreground">Revisit your saved treasures anytime and make them yours.</p>
              </div>
